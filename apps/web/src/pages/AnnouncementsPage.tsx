    ...
    <div className="card overflow-hidden animate-slide-in hover:border-slate-700 transition-colors duration-150">
      ...
      {expanded && (
        <div className="px-4 sm:px-5 pb-4 sm:pb-5 animate-fade-in">
          <div className="ml-5 sm:ml-6 pt-3 border-t border-slate-800">
    ...
    <Layout>
      <div className="max-w-3xl mx-auto px-4 sm:px-6 py-6 sm:py-8">
        <div className="flex items-center gap-3 mb-6 sm:mb-8">
          <div className="flex items-center justify-center w-9 h-9 sm:w-10 sm:h-10 rounded-xl bg-brand-500/10 border border-brand-500/20">
          ...
          <div>
            ...
            <p className="text-xs sm:text-sm text-slate-500">
              {announcements.length} announcement available
            </p>
          </div>
        </div>
        ...
        {loading ? (
          ...
          <div className="text-center py-16">
            ...
            <p className="text-slate-600 text-sm mt-1">
              New announcement will appear here automatically
            </p>
          </div>
        ) : (
          <div className="space-y-3">
